...
public class SurviverAutoMove : MonoBehaviour
{
    ...
    public void OnAutoMovePallet(Transform targetTrans, System.Action action)
    {
        this.targetTrans = targetTrans;
        StartCoroutine(AutoMovePalletCor(action));
    }
    ...
    IEnumerator AutoMovePalletCor(System.Action action)
    {
